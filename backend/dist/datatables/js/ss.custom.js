...
// dataSrc="data" it is array source of data
   ...
   function initDatatable(_selector,_url,params={},rm_export_btn=[],pageLength=50,aoColumnDefs=[{ "bSortable": false, "aTargets": [ -1 ] ,'sClass': 'dt-body-right'}],searching=true,aaSorting=[],dataSrc="data"){
